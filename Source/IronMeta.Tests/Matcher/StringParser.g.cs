...
namespace IronMeta.UnitTests.Matcher
{
    ...
    using _StringParser_Memo = IronMeta.Matcher.MatchState<string, int>;
    using _StringParser_Rule = System.Action<IronMeta.Matcher.MatchState<string, int>, int, IEnumerable<IronMeta.Matcher.MatchItem<string, int>>>;
    using _StringParser_Base = IronMeta.Matcher.Matcher<string, int>;

    public partial class StringParser : Matcher<string, int>
    {
        public StringParser()
            : base()
        {
