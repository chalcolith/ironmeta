//
// IronMeta TestParser Parser; Generated 2014-06-03 18:12:51Z UTC
//
...
namespace IronMeta.Tests.Matcher.Basics
{
    ...
    using _TestParser_Item = IronMeta.Matcher.MatchItem<char, int>;
    using _TestParser_Args = IEnumerable<IronMeta.Matcher.MatchItem<char, int>>;
    using _TestParser_Memo = Memo<char, int>;
    using _TestParser_Rule = System.Action<Memo<char, int>, int, IEnumerable<IronMeta.Matcher.MatchItem<char, int>>>;
    using _TestParser_Base = IronMeta.Matcher.Matcher<char, int>;

    public partial class TestParser : IronMeta.Matcher.CharMatcher<int>
    {
        public TestParser()
            : base()
        {
        ...
        public void TestInputs(_TestParser_Memo _memo, int _index, _TestParser_Args _args)
        {
        ...
        label1: // AND
            ...
            {
                _memo.Results.Pop();
                _memo.Results.Push( new _TestParser_Item(_r0.StartIndex, _r0.NextIndex, _memo.InputEnumerable, _Thunk(_IM_Result => { return Input(_IM_Result) == "abc" ? 1 : 0; }, _r0), true) );
            }
        ...
        label1: // AND
            ...
            _memo.Results.Push( _r9 == null ? new _TestParser_Item(_start_i9, _memo.InputEnumerable) : null);
            _index = _start_i9;
        ...
        public void TestReturn(_TestParser_Memo _memo, int _index, _TestParser_Args _args)
        {
        ...
        public void TestReturn1(_TestParser_Memo _memo, int _index, _TestParser_Args _args)
        {
            ...
            {
                _memo.Results.Pop();
                _memo.Results.Push( new _TestParser_Item(_r0.StartIndex, _r0.NextIndex, _memo.InputEnumerable, _Thunk(_IM_Result => { return new List<int> { 1, 2, 3}; }, _r0), true) );
            }

        }


        public void TestReturn2(_TestParser_Memo _memo, int _index, _TestParser_Args _args)
        {
            ...
            {
                _memo.Results.Pop();
                _memo.Results.Push( new _TestParser_Item(_r0.StartIndex, _r0.NextIndex, _memo.InputEnumerable, _Thunk(_IM_Result => { return new List<int> { 4, 5, 6}; }, _r0), true) );
            }

        }


        public void TestReturn3(_TestParser_Memo _memo, int _index, _TestParser_Args _args)
        {
            ...
            {
                _memo.Results.Pop();
                _memo.Results.Push( new _TestParser_Item(_r0.StartIndex, _r0.NextIndex, _memo.InputEnumerable, _Thunk(_IM_Result => { return new List<int> { 7, 8, 9}; }, _r0), true) );
            }

        }


        public void TestCount(_TestParser_Memo _memo, int _index, _TestParser_Args _args)
        {
        ...
        label1: // AND
            ...
            _memo.Results.Push( _r10 == null ? new _TestParser_Item(_start_i10, _memo.InputEnumerable) : null);
            _index = _start_i10;
