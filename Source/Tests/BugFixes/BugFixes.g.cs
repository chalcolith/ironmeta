...
namespace IronMeta.Tests.BugFixes
{
    ...
    using _BugFixes_Memo = Memo<char, object>;
    using _BugFixes_Rule = System.Action<Memo<char, object>, int, IEnumerable<IronMeta.Matcher.MatchItem<char, object>>>;
    using _BugFixes_Base = IronMeta.Matcher.Matcher<char, object>;

    public partial class BugFixes : IronMeta.Matcher.CharMatcher<object>
    {
        public BugFixes()
            : base()
        { }
