//
// IronMeta Parser Parser; Generated 2016-03-30 04:28:26Z UTC
//
...
namespace IronMeta.Generator
{
    ...
    using _Parser_Results = IEnumerable<AST.AstNode>;
    using _Parser_Item = IronMeta.Matcher.MatchItem<char, AST.AstNode>;
    using _Parser_Args = IEnumerable<IronMeta.Matcher.MatchItem<char, AST.AstNode>>;
    using _Parser_Memo = IronMeta.Matcher.MatchState<char, AST.AstNode>;
    using _Parser_Rule = System.Action<IronMeta.Matcher.MatchState<char, AST.AstNode>, int, IEnumerable<IronMeta.Matcher.MatchItem<char, AST.AstNode>>>;
    using _Parser_Base = IronMeta.Matcher.Matcher<char, AST.AstNode>;

    public partial class Parser : Matcher<char, AST.AstNode>
    {
        public Parser()
            : base()
        {
        ...
        label5: // AND
            ...
            _r11 = _MemoCall(_memo, "Preamble", _index, Preamble, null);
        ...
        label4: // AND
            ...
            _r13 = _MemoCall(_memo, "Grammar", _index, Grammar, null);
        ...
        label2: // AND
            ...
            _r15 = _MemoCall(_memo, "EOF", _index, EOF, null);
        ...
        public void Preamble(_Parser_Memo _memo, int _index, _Parser_Args _args)
        {
            ...
            // PLUS 2
            int _start_i2 = _index;
            var _res2 = Enumerable.Empty<AST.AstNode>();
        label2:
        ...
        public void Using(_Parser_Memo _memo, int _index, _Parser_Args _args)
        {
            ...
            var _res8 = Enumerable.Empty<AST.AstNode>();
        label8:
        ...
        public void Grammar(_Parser_Memo _memo, int _index, _Parser_Args _args)
        {
            ...
            _r13 = _MemoCall(_memo, "IRONMETA", _index, IRONMETA, null);
            ...
            _r15 = _MemoCall(_memo, "Identifier", _index, Identifier, null);
        ...
        label12: // AND
            ...
            _r16 = _MemoCall(_memo, "LESS", _index, LESS, null);
        ...
        label11: // AND
            ...
            _r18 = _MemoCall(_memo, "GenericId", _index, GenericId, null);
        ...
        label8: // AND
            ...
            _r22 = _MemoCall(_memo, "GenericId", _index, GenericId, null);
        ...
        label7: // AND
            ...
            _r23 = _MemoCall(_memo, "SP", _index, SP, null);
        ...
        label6: // AND
            ...
            _r24 = _MemoCall(_memo, "GREATER", _index, GREATER, null);
        ...
        label5: // AND
            ...
            _r28 = _MemoCall(_memo, "COLON", _index, COLON, null);
            ...
            _r30 = _MemoCall(_memo, "GenericId", _index, GenericId, null);
        ...
        label27: // AND
            ...
            {
                _memo.Results.Push( new _Parser_Item(_start_i27, _index, _memo.InputEnumerable, _r27_1.Results.Concat(_r27_2.Results).Where(_NON_NULL), true) );
            }
            else
            {
                _memo.Results.Push(null);
            ...
            _r31 = _MemoCall(_memo, "SP", _index, SP, null);
        ...
        label26: // AND
            ...
            {
                _memo.Results.Push( new _Parser_Item(_start_i26, _index, _memo.InputEnumerable, _r26_1.Results.Concat(_r26_2.Results).Where(_NON_NULL), true) );
            }
            else
            {
                _memo.Results.Push(null);
        ...
        label4: // AND
            ...
            _r32 = _MemoCall(_memo, "BRA", _index, BRA, null);
        ...
        label3: // AND
            ...
            var _res34 = Enumerable.Empty<AST.AstNode>();
        label34:

            // CALLORVAR Rule
            _Parser_Item _r35;

            _r35 = _MemoCall(_memo, "Rule", _index, Rule, null);
        ...
        label2: // AND
            ...
            _r36 = _MemoCall(_memo, "KET", _index, KET, null);
        ...
        label1: // AND
            ...
            {
                _memo.Results.Pop();
                _memo.Results.Push( new _Parser_Item(_r0.StartIndex, _r0.NextIndex, _memo.InputEnumerable, _Thunk(_IM_Result => { return new AST.Rule(name, 
                                 parms.Inputs.Any() 
                                     ? new AST.Args(parms, body) 
                                     : (AST.AstNode)body, 
                                 new string(ovr.Inputs.ToArray())); }, _r0), true) );
            }
        ...
        public void Disjunction(_Parser_Memo _memo, int _index, _Parser_Args _args)
        {
            ...
            // STAR 3
            int _start_i3 = _index;
            var _res3 = Enumerable.Empty<AST.AstNode>();
        label3:
        ...
        label1: // AND
            ...
            if (_r0 != null)
            {
                ...
                _memo.Results.Push( new _Parser_Item(_r0.StartIndex, _r0.NextIndex, _memo.InputEnumerable, _Thunk(_IM_Result => { return _IM_Result.Results
                   ...
                   .Aggregate<AST.AstNode, AST.AstNode>(null, (prev, cur) => prev != null ? new AST.Or(prev, cur) : cur); }, _r0), true) );
            }
        ...
        public void SequenceExp(_Parser_Memo _memo, int _index, _Parser_Args _args)
        {
            ...
            // PLUS 1
            int _start_i1 = _index;
            var _res1 = Enumerable.Empty<AST.AstNode>();
        label1:
            ...
            if (_r0 != null)
            {
                ...
                _memo.Results.Push( new _Parser_Item(_r0.StartIndex, _r0.NextIndex, _memo.InputEnumerable, _Thunk(_IM_Result => { return _IM_Result.Results
                    .Where(node => node != null)
                    .Aggregate<AST.AstNode, AST.AstNode>(null, (prev, cur) => prev != null ? new AST.And(prev, cur) : cur); }, _r0), true) );
            }
        ...
        label1: // AND
            ...
            {
                _memo.Results.Pop();
                _memo.Results.Push( new _Parser_Item(_r0.StartIndex, _r0.NextIndex, _memo.InputEnumerable, _Thunk(_IM_Result => { int min = int.Parse(new string(n.Inputs.ToArray()));
        ...
        public void CallOrVar(_Parser_Memo _memo, int _index, _Parser_Args _args)
        {
            ...
            _r4 = _MemoCall(_memo, "KEYWORD", _index, KEYWORD, null);

            if (_r4 != null) _index = _r4.NextIndex;

            // NOT 3
            var _r3 = _memo.Results.Pop();
            _memo.Results.Push( _r3 == null ? new _Parser_Item(_start_i3, _memo.InputEnumerable) : null);
            _index = _start_i3;
            ...
            _r6 = _MemoCall(_memo, "QualifiedId", _index, QualifiedId, null);
        ...
        public void Literal(_Parser_Memo _memo, int _index, _Parser_Args _args)
        {
            ...
            _r4 = _MemoCall(_memo, "Regexp", _index, Regexp, null);
            ...
            {
                _memo.Results.Pop();
                _memo.Results.Push( new _Parser_Item(_r3.StartIndex, _r3.NextIndex, _memo.InputEnumerable, _Thunk(_IM_Result => { return new AST.Regexp(_IM_Result); }, _r3), true) );
            }
            ...
            // COND
            if (_memo.Results.Peek() == null || !(((AST.Regexp)r.Results.First()).IsValid)) { _memo.Results.Pop(); _memo.Results.Push(null); _index = _start_i1; }
            ...
            _r10 = _MemoCall(_memo, "NEW", _index, NEW, null);
            ...
            _r13 = _MemoCall(_memo, "GenericId", _index, GenericId, null);
        ...
        label18: // OR
            ...
            _memo.Results.Push( _r17 != null ? new _Parser_Item(_start_i17, _memo.InputEnumerable) : null );
            _index = _start_i17;
        ...
        label7: // OR
            ...
            _r23 = _MemoCall(_memo, "CSharpCode", _index, CSharpCode, null);
        ...
        label6: // AND
            ...
            {
                _memo.Results.Pop();
                _memo.Results.Push( new _Parser_Item(_r5.StartIndex, _r5.NextIndex, _memo.InputEnumerable, _Thunk(_IM_Result => { return new AST.Code(_IM_Result); }, _r5), true) );
            }
        ...
        public void Regexp(_Parser_Memo _memo, int _index, _Parser_Args _args)
        {
            ...
            // PLUS 4
            int _start_i4 = _index;
            var _res4 = Enumerable.Empty<AST.AstNode>();
        label4:
        ...
        public void CSharpCodeItem(_Parser_Memo _memo, int _index, _Parser_Args _args)
        {
            ...
            // STAR 6
            int _start_i6 = _index;
            var _res6 = Enumerable.Empty<AST.AstNode>();
        label6:
        ...
        label3: // AND
            ...
            var _res21 = Enumerable.Empty<AST.AstNode>();
        label21:
        ...
        label2: // OR
            ...
            var _res36 = Enumerable.Empty<AST.AstNode>();
        label36:
        ...
        label1: // OR
            ...
            var _res51 = Enumerable.Empty<AST.AstNode>();
        label51:
        ...
        public void GenericId(_Parser_Memo _memo, int _index, _Parser_Args _args)
        {
            ...
            _r4 = _MemoCall(_memo, "Ident", _index, Ident, null);
            ...
            // STAR 5
            int _start_i5 = _index;
            var _res5 = Enumerable.Empty<AST.AstNode>();
        label5:
            ...
            _r7 = _MemoCall(_memo, "DOT", _index, DOT, null);
            ...
            _r8 = _MemoCall(_memo, "Ident", _index, Ident, null);
        ...
        label3: // AND
            ...
            _r13 = _MemoCall(_memo, "LESS", _index, LESS, null);
            ...
            _r17 = _MemoCall(_memo, "SP", _index, SP, null);
        ...
        label15: // AND
            ...
            // STAR 18
            int _start_i18 = _index;
            var _res18 = Enumerable.Empty<AST.AstNode>();
        label18:
            ...
            _r21 = _MemoCall(_memo, "COMMA", _index, COMMA, null);
        ...
        public void SP(_Parser_Memo _memo, int _index, _Parser_Args _args)
        {
            ...
            // STAR 0
            int _start_i0 = _index;
            var _res0 = Enumerable.Empty<AST.AstNode>();
        label0:
        ...
        label1: // AND
            ...
            var _res13 = Enumerable.Empty<AST.AstNode>();
        label13:
