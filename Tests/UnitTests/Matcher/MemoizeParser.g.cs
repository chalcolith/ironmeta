...
namespace IronMeta.UnitTests.Matcher
{
    ...
    using _MemoizeParser_Memo = IronMeta.Matcher.MatchState<char, Node>;
    using _MemoizeParser_Rule = System.Action<IronMeta.Matcher.MatchState<char, Node>, int, IEnumerable<IronMeta.Matcher.MatchItem<char, Node>>>;
    using _MemoizeParser_Base = IronMeta.Matcher.Matcher<char, Node>;

    public partial class MemoizeParser : Matcher<char, Node>
    {
