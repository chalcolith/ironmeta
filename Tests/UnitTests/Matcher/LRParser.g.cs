...
namespace IronMeta.UnitTests.Matcher
{
    ...
    using _LRParser_Memo = IronMeta.Matcher.MatchState<char, string>;
    using _LRParser_Rule = System.Action<IronMeta.Matcher.MatchState<char, string>, int, IEnumerable<IronMeta.Matcher.MatchItem<char, string>>>;
    using _LRParser_Base = IronMeta.Matcher.Matcher<char, string>;

    public partial class LRParser : Matcher<char, string>
    {
        public LRParser()
            : base()
        {
